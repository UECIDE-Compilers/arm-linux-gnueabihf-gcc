...
/* Package name      : perl5
 * Source directory  : .
 * Configuration time: Sat Jun  6 19:24:51 UTC 2015
 * Configured by     : Debian Project
 * Target system     : linux bm-wb-01 3.19.0-trunk-armmp #1 smp debian 3.19.1-1~exp1+plugwash1 (2015-03-28) armv7l gnulinux 
 */
